...
BOOTSTRAP_REPO_URL="${BOOTSTRAP_REPO_URL:-$BOOTY_REPO_URL}"

export BOOTSTRAP_REPO_URL BOOTY_REPO_URL BOOTY_SECRETS_URL BOOTSTRAP_MULTILIB BOOTSTRAP_TIMEZONE BOOTSTRAP_USER
